...
class TestVirtualMeetingAdmin:
    ...
    def test_admin_readonly_fields(self):
        expected = ('created_by_user_display', 'created_at', 'updated_at', 'status_assembleia')
    ...
    def test_admin_principal_fields(self):
        ...
        for f in ('condominium', 'title', 'voting_type', 'meeting_date_time_start',
                  'meeting_date_time_end', 'president', 'secretary'):
            assert f in fields
    ...
    def test_admin_add_view_creates_with_created_by_user(self, _condo, _assembly_status, _user):
    ...
    def test_admin_add_view_saves_participants(self, _condo, _assembly_status, _user, _resident_type, _resident):
        from django.test import Client
        from django.utils import timezone
        _user.is_staff = True
        _user.is_superuser = True
    ...
    def test_admin_add_view_saves_topics_without_valueerror(self, _condo, _assembly_status, _user):
        from django.test import Client
        from django.utils import timezone
        _user.is_staff = True
        _user.is_superuser = True
    ...
    def test_admin_add_view_rejects_duplicate_topic_titles(self, _condo, _assembly_status, _user):
        from django.test import Client
        from django.utils import timezone
        _user.is_staff = True
        _user.is_superuser = True
